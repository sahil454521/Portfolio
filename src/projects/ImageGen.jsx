...
const ImageGen = () => {
  ...
  const codeSnippets = [
    ...
    },
    {
      ...
      language: "python",
      code: `def setup_ui():
    # Create Gradio interface for the image generator
    with gr.Blocks(css="style.css") as demo:
        gr.HTML("<h1>Stable Diffusion Image Generator</h1>")
        ...
        with gr.Row():
            with gr.Column():
                ...
                negative_prompt = gr.Textbox(
                    ...
                    placeholder="blurry, bad quality, worst quality"
                )
        ...
        >
          ...
          <div className='flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6'>
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className='bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg transition duration-300 flex items-center justify-center shadow-lg'
            >
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
